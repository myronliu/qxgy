...
Toast.show = function(msg, duration){
  ...
  s.innerHTML = msg;
  //s.style.cssText="width:80%; font-size:12px; min-width:100px;opacity:0.5; height:40px; color:#fff; line-height:40px; text-align:center; border-radius:5px; z-index:999999; font-weight:bold; filter: alpha(opacity=80);background-color:black;margin:0 auto;";
